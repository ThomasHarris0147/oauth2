...
import io.muzoo.scalable.nettube.videoclient.upload.compress.PythonJavaHelper;
import io.muzoo.scalable.nettube.videoclient.upload.storage.*;
...
public class FileUploadController {
    ...
    public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file,
        ...
        try {
            PythonJavaHelper.sendTaskToWorkers(
